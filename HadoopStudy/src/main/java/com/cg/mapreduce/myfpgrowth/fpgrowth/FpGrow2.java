...
public class FpGrow2 {
    public static final int minSuport = 500;
    ...
    public static void FPGrowth(List<List<String>> transRecords,
        ...
        for (TreeNode header : HeaderTable) {
        	count++;
			System.out.print(header.getCount() + "times"+ "\t" + header.getName());
			if (postPattern != null) {
    ...
    // 构建项头表，同时也是频繁1项集
    public static ArrayList<TreeNode> buildHeaderTable(List<List<String>> transRecords) {
    ...
    // 构建FP-Tree
    public static TreeNode buildFPTreeSrc(List<List<String>> transRecords,
