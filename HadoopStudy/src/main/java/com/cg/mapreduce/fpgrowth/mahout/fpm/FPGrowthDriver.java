...
package com.cg.mapreduce.fpgrowth.mahout.fpm;
...
import com.cg.mapreduce.fpgrowth.mahout.fpm.convertors.ContextStatusUpdater;
import com.cg.mapreduce.fpgrowth.mahout.fpm.convertors.SequenceFileOutputCollector;
import com.cg.mapreduce.fpgrowth.mahout.fpm.convertors.string.StringOutputConverter;
import com.cg.mapreduce.fpgrowth.mahout.fpm.convertors.string.TopKStringPatterns;
import com.cg.mapreduce.fpgrowth.mahout.fpm.fpgrowth.FPGrowth;
...
public final class FPGrowthDriver extends AbstractJob {
  ...
  public static void main(String[] args) throws Exception {
	...
	System.out.println("π≤”√ ±£∫ " + (endTime - startTime) + "ms");
  }
  ...
  private static void runFPGrowth(Parameters params) throws IOException {
    ...
    if ("true".equals(params.get(PFPGrowth.USE_FPG2))) {
      com.cg.mapreduce.fpgrowth.mahout.fpm.fpgrowth2.FPGrowthObj<String> fp 
        = new com.cg.mapreduce.fpgrowth.mahout.fpm.fpgrowth2.FPGrowthObj<String>();
