 ...
 * @since 2016-6-21
 */
public class IndicatorJob006 extends BaseJob {
    ...
    public void setJobSpecialInfo(Job job, Configuration conf,
        ...
        job.setMapperClass(IndicatorJob006.RationMapper.class);
        job.setReducerClass(IndicatorJob006.RationReducer.class);
