 ...
 * @since 2016-7-4
 */
public class NewJugementJob extends BaseJob {
...
//            resultObj.put("total_diff_num_called_from_tel_library", 0);
	...
	public void setJobSpecialInfo(Job job, Configuration conf,
		...
		job.setMapperClass(NewJugementJob.MapSevralTemp.class);
		...
		FileInputFormat.addInputPath(job, tempPaths.get(NewIndicatorJob006.class.getName()));
