...
//        
//        job1.setJarByClass(ChubaoLargeCondition1_2.class);
//        job1.setMapperClass(LargeMapper.class);
//        job1.setReducerClass(LargeReducer.class);
//        job1.setCombinerClass(LargeCombiner.class);
...
//        
//        job2.setJarByClass(RationJob.class);
...
//        job3.setJarByClass(LargePriceJob.class);
